...
class CSmtp {
  ...
  public:
    ...
    string title;
    string content;
    string boundary = string("----=_NextPart_000_00C0_01CC1E0D");
    string auther   = string("\n\n This email was sent from NPUHeart, authored by Ma Pengfei.");
  ...
  public:
    ...
    int   SendEmail_Ex();
    char* base64Encode(const char* pOrigSigned, unsigned origLength);
};
int email_notification(CSmtp& smtp);
int email_notification(string to, string content);
