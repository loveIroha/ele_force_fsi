...
#ifndef _ELERIAN_LAGRANGIAN_INTERACTION_H_
#define _ELERIAN_LAGRANGIAN_INTERACTION_H_
...
class ElerianLagrangianInteraction {
  ...
  public:
    ...
    std::shared_ptr<ImmersedMesh>    get_solid_mesh() const { return _solid_mesh; }

    ElerianLagrangianInteraction(std::shared_ptr<BackgroundMesh2> fluid_mesh, std::shared_ptr<ImmersedMesh> solid_mesh)
