/// @date 2023-04-12
/// @file LidDrivenFlow.h
/// @author Ma Pengfei (code@pengfeima.cn)
/// @version 0.1
/// @copyright Copyright (c) 2023 Ma Pengfei
///
/// @brief Lid Driven Flow 方腔顶盖驱动流
///
...
class LidDrivenFlow {
  ...
  public:
    LidDrivenFlow(int3 dim, double3 dh, double dt, double nu, double rho,
        ...
        init_boundary_conditions(u0, vbcs, dim, DIRICHLET, double3{0, 0, 0}, DIRICHLET, double3{0, 0, 0}, DIRICHLET,
                                 double3{0, 0, 0}, DIRICHLET, double3{0, 0, 0}, DIRICHLET, double3{0, 0, 0}, DIRICHLET,
                                 double3{1, 0, 0});

        init_boundary_conditions(p0, pbcs, dim, NEUMANN, 0.0, NEUMANN, 0.0, NEUMANN, 0.0, NEUMANN, 0.0, NEUMANN, 0.0,
                                 NEUMANN, 0.0);
