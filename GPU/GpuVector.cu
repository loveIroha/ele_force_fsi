...
template char gpu_abs_max<char>(char* a, size_t num);
...
template char gpu_sum<char>(char* a, size_t num);
...
template char gpu_min<char>(char* a, size_t num);
...
template char gpu_max<char>(char* a, size_t num);
...
template char gpu_inner<char>(char* a, char* b, size_t num);
...
template void gpu_axpy<char>(char* z, const char* x, const char* y, char a, size_t num);
...
template void gpu_fill(char* x, char a, size_t num);
