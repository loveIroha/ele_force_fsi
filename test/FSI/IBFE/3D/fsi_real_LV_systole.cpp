...
#include <PhysicsSolver/SolidSolver/RealLeftVentricleSystole/RealLeftVentricleSolver.h>
...
double diastole_pressure = 8;
double systole_pressure  = 100;
double max_tension       = 600;
...
std::string id = "";
std::string mesh_path = "/mnt/large2/gjh/realistic_left_ventricle";
...
int fsi_simulation(std::shared_ptr<dolfin::Mesh>                      solid_mesh_dolfin,
    ...
    double rho = param::rho;
    {
        ...
        auto solid_solver = std::make_shared<LocalSolidSolver>(
            ...
            param::s00, param::s01, param::s02,
            param::diastole_pressure,param::systole_pressure, param::max_tension,
            param::kappa, param::beta, param::path);
...
void left_ventricle() {
    ...
    // 读取边界文件
    auto solid_mesh_boundary = std::make_shared<dolfin::MeshFunction<std::size_t>>(solid_mesh_dolfin, param::mesh_path + "boundaries.xml");
...
const std::string config_file = argv[1];
    ...
    param::diastole_pressure   = param::json->get_value<double>("diastole_pressure");
    param::systole_pressure = param::json->get_value<double>("systole_pressure");
    param::max_tension  = param::json->get_value<double>("max_tension");
