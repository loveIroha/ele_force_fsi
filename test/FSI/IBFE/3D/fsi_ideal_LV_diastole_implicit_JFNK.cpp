/// @date 2023-11-01
/// @file fsi_ideal_LV_diastole.cpp
/// @author Ma Pengfei (code@pengfeima.cn)
/// @version 0.1
/// @copyright Copyright (c) 2023 Ma Pengfei
///
/// @brief
///         2022-03-23 添加理想左心室模型
///         2023-05-08 调通理想左心室模型
///         2023-11-01 在新的流体求解器下实现理想左心室模型
...
int fsi_simulation(std::shared_ptr<dolfin::Mesh>                      solid_mesh_dolfin,
    ...
    double     rho  = 1.0;
    const auto path = fmt::format("ideal_LV_diastole_3D_implicit_{}_{}_{}_{:.1f}_with_{:.2e}_{:.2e}_{:.2e}/", Ns, Nf,
                                  Nt, T, mu_f, param::kappa, param::beta);
    {
        ...
        // 创建固体求解器
        auto solid_solver = std::make_shared<LocalSolidSolver>(solid_mesh->get_dolfin_mesh(), solid_mesh_boundary,
                                                               param::kappa, param::beta, path);
...
void bar_bending(int Ns, int Nf, int Nt, double T, double mu_f) {
    ...
    // 运行算例
    fsi_simulation(solid_mesh_dolfin, solid_mesh_boundary, Ns, Nf, Nt, T, mu_f);
}
