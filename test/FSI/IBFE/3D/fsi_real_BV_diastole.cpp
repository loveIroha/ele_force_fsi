...
#include <PhysicsSolver/SolidSolver/RealBiVentricle/RealBiVentricleSolver.h>
...
int fsi_simulation(std::shared_ptr<dolfin::Mesh>                      solid_mesh_dolfin,
    ...
    double     rho  = 1.0;
    const auto path = fmt::format("real_BV_diastole_3D_explicit_{}_{}_{}_{:.1f}_with_{:.2e}_{:.2e}_{:.2e}/", Ns, Nf, Nt,
