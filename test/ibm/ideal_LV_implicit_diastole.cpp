...
int main(int argc, char* argv[]) {
    ...
    solid_mesh_path << "../geometry/ventricle/LV/LV_ideal/LV_ideal_" << solid_mesh_size << ".xdmf";
    solid_mesh_boundary_path << "../geometry/ventricle/LV/LV_ideal/LV_ideal_" << solid_mesh_size << "_boundary.xml";
    ...
    result_path << "demo_ilv_implicit_" << fluid_mesh_size << "_" << solid_mesh_size << "_" << time_steps << "/";
        ...
        // If it is successful,
            ...
            *xn   = *xn_new;
            ...
            if (nonlinear_result.second.second < 10) {
                LOG_F(WARNING, "Solver iterations : %d, enlarge the time step.", nonlinear_result.second.second);
                dt_ratio = 1.5;
            } else if (nonlinear_result.second.second > 80) {
                LOG_F(WARNING, "Solver iterations : %d, smaller the time step.", nonlinear_result.second.second);
                dt_ratio = 0.5;
            } else {
                dt_ratio = 1.0;
            }
