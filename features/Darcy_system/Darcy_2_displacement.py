...
#位移是变量，边界是Dirichlet边界条件，验证Darcy方程组是正确的
...
S = Expression('0.14814814814814814*pow(x[0], 2)/pow(t + 0.33333333333333331*pow(x[0], 2) + 0.66666666666666663*pow(x[1], 2) + 0.66666666666666663, 3) + 2.3703703703703702*pow(x[1], 2)/pow(t + 0.33333333333333331*pow(x[0], 2) + 0.66666666666666663*pow(x[1], 2) + 0.66666666666666663, 3) - 8.0467014998419693 - 1.0/pow(t + 0.33333333333333331*pow(x[0], 2) + 0.66666666666666663*pow(x[1], 2) + 0.66666666666666663, 2)', degree=5, t=0)
K = 1.0*Identity(2)
